...
public class DemoQaHomePage {
	...
	@FindBy(xpath="//div[contains(@class,'home-body')]//div[2]//div[1]//div[2]//*[name()='svg']")
	WebElement formsLink;
	
	public void formsLinkClick() {
		formsLink.click();
	}
	...
	public void alertsFramesWindowsLinkClick() {
	...
	public void interactionsLinkClick() {
		interactions.click();
	}
	@FindBy(xpath="(//h5)[6]")
	...
	public void bookStoreAppilcationsLinkClick() {
		bookStoreAppilcations.click();
	}
